...
<p>Tickets are stored as simple numbered Markdown files inside the <code>tickets</code> folder:</p>
...
<ul>
  ...
  <li>File share and permission troubleshooting</li>
  <li>Printer access and queue issues</li>
  <li>Group Policy investigation</li>
  <li>Login and authentication problems</li>
  <li>Distribution group and email access</li>
  <li>General domain troubleshooting</li>
</ul>
